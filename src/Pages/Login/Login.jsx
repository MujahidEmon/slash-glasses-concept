  ...
  return (
    <div className="flex border-2 mt-6 bg-base-100 rounded-lg max-w-xl mx-auto  font-montserrat justify-center ">
      <form onSubmit={handleLogin} className="max-w-lg w-full p-6 mx-auto">
        ...
        <div className="">
          <div>
            <label className="text-gray-800 text-sm block font-bold mb-2">
              Email
            </label>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
            ...
            <div>
              <a className="text-[#F9A51A] font-semibold text-sm hover:underline cursor-pointer">
                Forgot Password?
              </a>
            </div>
          </div>
          ...
          <div className="mt-6">
            <button className="w-full btn font-bold py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-[#F9A51A]">
              Sign in
            </button>
            <p className="text-gray-800 text-sm text-center mt-2">
              Don't have an account ?{" "}
              <Link to={"/Register"} className="text-[#F9A51A] font-bold">
                Register here
              </Link>
            </p>
          </div>
